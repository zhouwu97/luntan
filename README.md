...
基于「贴吧的信息结构 + 社区高效入口 + 浅蓝年轻化视觉」实现的 Android / iOS Flutter 移动 App。参考仓库 `https://github.com/zhouwu97/luntan` 当前为空仓库，因此本工程以产品说明为实现依据。
...
- 下拉刷新和筛选行刷新状态
- 首页 / 发布 / 我的三段底部导航
- 普通帖子、投票、玩法分享发布入口；普通帖和玩法分享可真实加入本地信息流
