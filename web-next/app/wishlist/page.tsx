...
export default function WishlistPage() {
  ...
  return (
    <>
      ...
      <div className="wishlist-mobile-header"><button type="button" aria-label="返回" onClick={() => router.back()}><Icon name="chevron-left" size={22} /></button><h1>想冲清单</h1></div>
      <main className="page-frame wishlist-page">
        <button type="button" className="back-link wishlist-desktop-back" onClick={() => router.back()}><Icon name="chevron-left" size={17} />返回商品详情</button>
