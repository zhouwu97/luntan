...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case r.Method == http.MethodPut && path == "/api/v1/admin/ranking/reorder":
		...
		return
	case r.Method == http.MethodGet && path == "/api/v1/admin/ranking/views":
		s.adminRankingView(w, r)
		return
	case r.Method == http.MethodPut && path == "/api/v1/admin/ranking/views/order":
		s.reorderRankingView(w, r)
		return
